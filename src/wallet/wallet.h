...
#ifndef BITCOINRAND_WALLET_WALLET_H
#define BITCOINRAND_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinrand node, and set to 0 for transactions that were created
...
#endif // BITCOINRAND_WALLET_WALLET_H
