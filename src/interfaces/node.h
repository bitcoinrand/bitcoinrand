...
#ifndef BITCOINRAND_INTERFACES_NODE_H
#define BITCOINRAND_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinrand node (bitcoinrandd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINRAND_INTERFACES_NODE_H
