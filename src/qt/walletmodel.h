...
#ifndef BITCOINRAND_QT_WALLETMODEL_H
#define BITCOINRAND_QT_WALLETMODEL_H
...
/** Interface to Bitcoinrand wallet from Qt view code. */
...
#endif // BITCOINRAND_QT_WALLETMODEL_H
