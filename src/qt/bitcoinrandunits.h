...
#ifndef BITCOINRAND_QT_BITCOINRANDUNITS_H
#define BITCOINRAND_QT_BITCOINRANDUNITS_H
...
/** Bitcoinrand unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinrandUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinrandUnits(QObject *parent);

    /** Bitcoinrand units.
      @note Source: https://en.bitcoinrand.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BZAR,
...
typedef BitcoinrandUnits::Unit BitcoinrandUnit;

#endif // BITCOINRAND_QT_BITCOINRANDUNITS_H
