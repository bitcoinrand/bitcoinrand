    ...
    mapper(0)
{
    ...
    ui->bitcoinrandAtStartup->setToolTip(ui->bitcoinrandAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinrandAtStartup->setText(ui->bitcoinrandAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinrandConfButton->setToolTip(ui->openBitcoinrandConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinrandUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinrandAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinrandConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinrandConf())
