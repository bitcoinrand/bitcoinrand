 ...
 */
#ifndef BITCOINRAND_UTIL_H
#define BITCOINRAND_UTIL_H
...
extern const char * const BITCOINRAND_CONF_FILENAME;
extern const char * const BITCOINRAND_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinrand-%s", name);
