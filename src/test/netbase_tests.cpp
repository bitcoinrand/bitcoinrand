...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinrandcore.org", "www.bitcoinrandcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinrandcore.org]", "www.bitcoinrandcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinrandcore.org:80", "www.bitcoinrandcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinrandcore.org]:80", "www.bitcoinrandcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:19452", "127.0.0.1", 19452));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:19452", "127.0.0.1", 19452));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:19452", "::ffff:127.0.0.1", 19452));
    BOOST_CHECK(TestSplitHost("[::]:19452", "::", 19452));
    BOOST_CHECK(TestSplitHost("::19452", "::19452", -1));
    BOOST_CHECK(TestSplitHost(":19452", "", 19452));
    BOOST_CHECK(TestSplitHost("[]:19452", "", 19452));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:19452", "127.0.0.1:19452"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:19452", "[::]:19452"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
