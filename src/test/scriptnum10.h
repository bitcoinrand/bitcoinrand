...
#ifndef BITCOINRAND_TEST_SCRIPTNUM10_H
#define BITCOINRAND_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoinrand Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINRAND_TEST_BIGNUM_H
