...
static void SetupBitcoinrandTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinrand-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinrand-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinrand transaction\n" +
            "or:     bitcoinrand-tx [options] -create [commands]   Create hex-encoded bitcoinrand transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinrand transaction
