...
#ifndef BITCOINRAND_KEYSTORE_H
#define BITCOINRAND_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bitcoinrand/bips/blob/master/bip-0013.mediawiki
