...
"""Verify that starting bitcoinrand with -h works as expected."""

from test_framework.test_framework import BitcoinrandTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinrandTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinrand with -h for help text")
        ...
        self.log.info("Start bitcoinrand with -version for version information")
        ...
        self.log.info("Start bitcoinrandd with -fakearg to make sure it does not start")
