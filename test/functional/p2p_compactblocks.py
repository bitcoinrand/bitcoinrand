...
# TestP2PConn: A peer we use to send messages to bitcoinrandd, and store responses.
...
class CompactBlocksTest(BitcoinrandTestFramework):
    ...
    # This test actually causes bitcoinrandd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinrandd's choice of nonce.
    ...
    # Test that bitcoinrandd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinrandd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinrandd will not send blocktxn responses for blocks whose height is
