...
This document provides guidelines for internationalization of the Bitcoinrand Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinrand_en.ts` remains unchanged.
